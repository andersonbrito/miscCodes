...
#
#   beast2JaneLadderized.py -> This script converts beast trees into Jane
#                       cophylogenetic format. A tab delimited
#                       auxiliary file containing virus-host pairs
#                       (one pair per line) is required. If any pair
...
#                       with no nodes assigned to it will be filled by taxa in an
#                       artifical ladderized outgroup added for this purpose.
#
# Usage: python beast2janeLadderized.py workingDirectory hostTree viralTree auxFile
#
# Release date: 22/08/2017
# Last update: 06/02/20178
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
